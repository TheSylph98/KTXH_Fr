import {
  ...
  export const state = () => {
    return {
      api: {
        chiTieuPhanToChiTiet: '/api/ChiTieuPhanToChiTiets'
      },
...
export const mutations = {
    ...
    RESTORE_CHI_TIEU_PHAN_TO_CHI_TIET: restore('chiTieuPhanToChiTiet')
}
...
export const actions = {
  ...
  async restoreChiTieuPhanToChiTiet({ state, commit }, chi_tieu_phan_to_chi_tiet) {
    ...
    try {
      ...
      commit('RESTORE_CHI_TIEU_PHAN_TO_CHI_TIET', data)
      commit('SET_PAGINATION_KEY', {
        property: 'total',
        value: state.pagination.total + 1
      })
